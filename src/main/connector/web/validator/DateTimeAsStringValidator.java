 ...
 */
@FacesValidator(value = "DateTimeAsStringValidator")
public class DateTimeAsStringValidator implements Validator
{
   ...
   * Default Constructor.
   */
  public DateTimeAsStringValidator()
  {
  }
  ...
  public void validate(FacesContext aContext, UIComponent aComponent, Object aValue) throws ValidatorException
  {
    try
    {
      LocalDateTime.parse(aValue.toString(), DATE_FORMAT);
    }
    catch (DateTimeParseException ex)
    {
      throw new ValidatorException(new FacesMessage(
              aComponent.getId() + ": Validation Error: Date must be in format dd/MM/yyyy HH:mm"));
    }
  }
}
