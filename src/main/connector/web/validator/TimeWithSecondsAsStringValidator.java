/*
 * Copyright 2021 EnergySys Limited. All Rights Reserved.
 *
 ...
 */
@FacesValidator(value = "TimeWithSecondsAsStringValidator")
public class TimeWithSecondsAsStringValidator implements Validator
{
   ...
   * Default Constructor.
   */
  public TimeWithSecondsAsStringValidator()
  {
  }
  ...
  public void validate(FacesContext aContext, UIComponent aComponent, Object aValue) throws ValidatorException
  {
    ...
    catch (DateTimeParseException ex)
    {
      throw new ValidatorException(new FacesMessage(
              aComponent.getId() + ": Validation Error: Date must be in format HH:mm:ss"));
    }
  }
}
